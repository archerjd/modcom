...
ConVar cl_sidespeed( "cl_sidespeed", "495", FCVAR_CHEAT ); // 450
ConVar cl_upspeed( "cl_upspeed", "320", FCVAR_CHEAT );
ConVar cl_forwardspeed( "cl_forwardspeed", "495", FCVAR_CHEAT ); // 450
ConVar cl_backspeed( "cl_backspeed", "495", FCVAR_CHEAT ); // 450
...
/*	disorientation
	...
	if ( pPlayer )
		return pPlayer->HandleDisorientationForButtons( bits );
	else
*/		return bits;
}

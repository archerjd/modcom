#ifndef MAKECHARPANEL_H
#define MAKECHARPANEL_H
#ifdef _WIN32
#pragma once
#endif
...
class CMakeCharPanel : public vgui::Frame, public IViewPortPanel
{
private:
	DECLARE_CLASS_SIMPLE( CMakeCharPanel, vgui::Frame );

public:
	CMakeCharPanel(IViewPort *pViewPort);
	virtual ~CMakeCharPanel();

	virtual void OnThink() {}
	virtual const char *GetName( void ) { return PANEL_MAKECHAR; }
...
private:
	...
	vgui::ComboBox *m_pFactionSelect;
	int m_iFaction;
};

...
// SHARED
	...
	//char					szViewModel_r[MAX_WEAPON_STRING];		// Resistance view model of this weapon
	//char					szViewModel_c[MAX_WEAPON_STRING];		// Combine view model of this weapon
	//char					szViewModel_a[MAX_WEAPON_STRING];		// Aperture view model of this weapon
	//bool bHasViewModelResistance, bHasViewModelCombine, bHasViewModelAperture;
	char					szWorldModel[MAX_WEAPON_STRING];		// Model of this weapon seen carried by the player
	//char					szWorldModel_r[MAX_WEAPON_STRING];		// Resistance model of this weapon seen carried by the player
	//char					szWorldModel_c[MAX_WEAPON_STRING];		// Combine model of this weapon seen carried by the player
	//char					szWorldModel_a[MAX_WEAPON_STRING];		// Aperture model of this weapon seen carried by the player
	//bool bHasWorldModelResistance, bHasWorldModelCombine, bHasWorldModelAperture;

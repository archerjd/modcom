...
ConVar	sv_noclipaccelerate( "sv_noclipaccelerate", "2", FCVAR_NOTIFY | FCVAR_ARCHIVE | FCVAR_REPLICATED);
...
ConVar	sv_maxspeed		( "sv_maxspeed", "495", FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY);
...
ConVar	sv_maxvelocity	( "sv_maxvelocity","7000", FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY, "Maximum speed any ballistically moving object is allowed to attain per axis." );

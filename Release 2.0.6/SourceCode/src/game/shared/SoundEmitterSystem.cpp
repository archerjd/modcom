...
void CSoundEmitterSystem::TraceEmitSound( char const *fmt, ... )
{
...
void CSoundEmitterSystem::LevelInitPostEntity()
{
}
...
void CSoundEmitterSystem::EmitCloseCaption( IRecipientFilter& filter, int entindex, bool fromplayer, char const *token, CUtlVector< Vector >& originlist, float duration, bool warnifmissing /*= false*/ )
{
...
void CSoundEmitterSystem::EmitAmbientSound( int entindex, const Vector& origin, const char *soundname, float flVolume, int iFlags, int iPitch, float soundtime /*= 0.0f*/, float *duration /*=NULL*/ )
{
	// Pull data from parameters
	CSoundParameters params;
...
void CSoundEmitterSystem::StopSound( int iEntIndex, int iChannel, const char *pSample )
{
...
void CSoundEmitterSystem::EmitAmbientSound( int entindex, const Vector &origin, const char *pSample, float volume, soundlevel_t soundlevel, int flags, int pitch, float soundtime /*= 0.0f*/, float *duration /*=NULL*/ )
{
#if !defined( CLIENT_DLL )

...
public:
	...
	virtual int		GetExtraClip(int clipSizeLevel) { return 0; };		// how much each level in the "ammo" player stat varies my clip by
...
public:
	...
	virtual int				GetDefaultClip1( void );
	virtual int				GetDefaultClip2( void );
	...
	virtual bool			UsesClipsForAmmo2( void );
	...
	void					SetClip(int val) { m_iClip1 = val; }

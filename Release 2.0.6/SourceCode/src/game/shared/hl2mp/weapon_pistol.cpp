...
extern McConVar weapon_pistol_primary_damage, weapon_pistol_primary_refire, weapon_pistol_primary_refire_fastest, weapon_pistol_clip_size, weapon_pistol_reload_time;

#define	PISTOL_FASTEST_REFIRE_TIME		weapon_pistol_primary_refire_fastest.GetFloat()
#define	PISTOL_FASTEST_DRY_REFIRE_TIME	weapon_pistol_primary_refire.GetFloat()
...
public:
	...
	virtual int		GetExtraClip(int clipSizeLevel) { return LEVEL(mod_clipsize_pistol, clipSizeLevel); }
	
	virtual int GetPrimaryAttackDamage() { return weapon_pistol_primary_damage.GetInt(); }
	virtual float GetPrimaryAttackRefire() { return weapon_pistol_primary_refire.GetFloat(); }
	virtual int GetSecondaryAttackDamage() { return 0; }
	virtual float GetSecondaryAttackRefire() { return 0; }
	virtual float GetReloadDuration() { return weapon_pistol_reload_time.GetFloat(); }
	virtual int GetClipSize() { return weapon_pistol_clip_size.GetInt(); }
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const { return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_PISTOL; }
#endif
#endif

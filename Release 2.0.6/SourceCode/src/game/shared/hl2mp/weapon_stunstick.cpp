...
public:
	...
	float		GetRange( void )		{ return weapon_melee_primary_range.GetFloat(); }
	float		GetFireRate( void )		{ return GetPrimaryAttackRefire(); }
	...
	virtual int GetPrimaryAttackDamage() { return weapon_melee_primary_damage.GetInt(); }
	virtual float GetPrimaryAttackRefire() { return weapon_melee_primary_refire.GetFloat(); }
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const { return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_STUNSTICK; }
#endif
#endif

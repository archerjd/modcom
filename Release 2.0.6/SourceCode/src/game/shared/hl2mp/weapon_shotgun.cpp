...
extern McConVar weapon_shotgun_pellet_damage, weapon_shotgun_primary_refire, weapon_shotgun_secondary_refire, weapon_shotgun_clip_size, weapon_shotgun_pump_time;
...
//	void WeaponIdle( void );
	...
	virtual int GetExtraClip(int clipSizeLevel) { return LEVEL(mod_clipsize_shotgun, clipSizeLevel); }
	
	virtual int GetPrimaryAttackDamage() { return weapon_shotgun_pellet_damage.GetInt(); }
	virtual float GetPrimaryAttackRefire() { return weapon_shotgun_primary_refire.GetFloat(); }
	virtual int GetSecondaryAttackDamage() { return weapon_shotgun_pellet_damage.GetInt(); }
	virtual float GetSecondaryAttackRefire() { return weapon_shotgun_secondary_refire.GetFloat(); }
	//virtual float GetReloadDuration() { return weapon_shotgun_reload_time.GetFloat(); }
	virtual int GetClipSize() { return weapon_shotgun_clip_size.GetInt(); }
	...
	DECLARE_ACTTABLE();
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const { return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_SHOTGUN; }
#endif
#endif
...
//-----------------------------------------------------------------------------
float CWeaponShotgun::GetFireRate() { return 0.7f; }
...
{
	if ( GetOwner()->IsBuffActive(DEBUFF_ATTRITION) )
		return false;
...
void CWeaponShotgun::Pump( void )
{
	...
	pOwner->m_flNextAttack = m_flNextPrimaryAttack = gpGlobals->curtime + weapon_shotgun_pump_time.GetFloat(); //SequenceDuration();
}
...
void CWeaponShotgun::SecondaryAttack( void )
{
	...
	// Don't fire again until fire animation has completed
	m_flNextPrimaryAttack = gpGlobals->curtime + GetSecondaryAttackRefire();

...
int CWeaponCrowbar::GetPrimaryAttackDamage() { return weapon_melee_primary_damage.GetInt(); }
float CWeaponCrowbar::GetPrimaryAttackRefire() { return weapon_melee_primary_refire.GetFloat(); }
...
#ifdef USE_OMNIBOT
#ifndef CLIENT_DLL
int CWeaponCrowbar::GetOmnibotClass() const 
{
	return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_CROWBAR; 
}
#endif
#endif
//-----------------------------------------------------------------------------

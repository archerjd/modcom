...
extern McConVar weapon_slam_satchel_damage, weapon_slam_satchel_refire, weapon_slam_tripmine_damage, weapon_slam_tripmine_refire, weapon_slam_tripmine_attach_range;
...
int CWeapon_SLAM::GetPrimaryAttackDamage() { return weapon_slam_satchel_damage.GetInt(); }
float CWeapon_SLAM::GetPrimaryAttackRefire() { return weapon_slam_satchel_refire.GetFloat(); }
int CWeapon_SLAM::GetSecondaryAttackDamage() { return weapon_slam_tripmine_damage.GetInt(); }
float CWeapon_SLAM::GetSecondaryAttackRefire() { return weapon_slam_tripmine_refire.GetFloat(); }
...
// Output :
//-----------------------------------------------------------------------------
void CWeapon_SLAM::StartTripmineAttach( bool ability )
{
...
bool CWeapon_SLAM::CanAttachSLAM( void )
{
	...
	Vector	vecEnd = vecSrc + (vecAiming * weapon_slam_tripmine_attach_range.GetFloat());
...
void CWeapon_SLAM::ItemPostFrame( void )
{
	...
	{
		// detonating remote mines shouldn't decloak you
		SecondaryAttack();
	}
...
#ifdef USE_OMNIBOT
#ifndef CLIENT_DLL
int CWeapon_SLAM::GetOmnibotClass() const 
{
	return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_SLAM; 
}
#endif
#endif
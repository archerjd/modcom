...
extern McConVar weapon_smg_primary_damage, weapon_smg_primary_refire, weapon_smg_secondary_damage, weapon_smg_secondary_radius, weapon_smg_secondary_refire, weapon_smg_clip_size, weapon_smg_reload_time;
...
public:
	...
	virtual int		GetExtraClip(int clipSizeLevel) { return LEVEL(mod_clipsize_smg, clipSizeLevel); }

	virtual int GetPrimaryAttackDamage() { return weapon_smg_primary_damage.GetInt(); }
	virtual float GetPrimaryAttackRefire() { return weapon_smg_primary_refire.GetFloat(); }
	virtual int GetSecondaryAttackDamage() { return weapon_smg_secondary_damage.GetInt(); }
	virtual float GetSecondaryAttackRefire() { return weapon_smg_secondary_refire.GetFloat(); }
	virtual float GetReloadDuration() { return weapon_smg_reload_time.GetFloat(); }
	virtual int GetClipSize() { return weapon_smg_clip_size.GetInt(); }
	
	float	GetFireRate( void ) { return GetPrimaryAttackRefire(); }	// 13.3hz
#ifndef CLIENT_DLL
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const { return Omnibot::MC_CLASSEX_WEAPON + Omnibot::MC_WP_SMG; }
#endif
#endif
...
void CWeaponSMG1::SecondaryAttack( void )
{
	...
	float damage = GetSecondaryAttackDamage() * pPlayer->GetDamageDealtScale();
	//damage += damage * pPlayer->GetFactionalDamageScaleBoost();
	pGrenade->SetDamage( damage );
	pGrenade->SetDamageRadius( weapon_smg_secondary_radius.GetFloat() );

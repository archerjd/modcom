...
#define DMG_FREEZE			(1<<30)
#define DMG_CRIT			(1<<31)		// a critical hit. Do fancy effects.
...
#define DMG_LASTGENERICFLAG	DMG_CRIT
...
#define COLOR_YELLOWISH	Color(255, 218, 36, 255) // combine color

...
public:
	...
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_HEALTHKIT;
	}
#endif
	void Spawn( void );
	void Precache( void );
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_HEALTHVIAL;
	}
#endif
	void Spawn( void )
	{
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_HEALTH_WALLUNIT;
	}
#endif
	void Spawn( );
	void Precache( void );
...
{
	if(ent && ent->GetOmnibotClass() == Omnibot::MC_CLASSEX_HEALTH_WALLUNIT)
	{

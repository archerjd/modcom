...
public:
	...
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_PISTOL_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_LARGE_PISTOL_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_SMG_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_LARGE_SMG_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_AR2_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_LARGE_AR2_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_357_AMMO;
	}
#endif
	void Precache( void )
	{
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_LARGE_357_AMMO;
	}
#endif
	void Precache( void )
	{
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_CROSSBOW_AMMO;
	}
#endif
	void Precache( void )
	{
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_FLARE_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_LARGE_FLARE_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_RPG_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_AR2GREN_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_SNIPER_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_SHOTGUN_AMMO;
	}
#endif
	void Spawn( void )
	{ 
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_AR2_ALTFIRE_AMMO;
	}
#endif
	void Precache( void )
	{
...
#ifdef USE_OMNIBOT
	int GetOmnibotClass() const {
		return Omnibot::MC_CLASSEX_AMMO_CRATE;
	}
#endif
	void	Spawn( void );
	void	Precache( void );

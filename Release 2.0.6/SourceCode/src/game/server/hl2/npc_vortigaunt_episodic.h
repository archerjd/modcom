...
extern McConVar sk_vortigaunt_zap_range;
...
public:
	...
	virtual float	InnateRange1MaxRange( void ) { return sk_vortigaunt_zap_range.GetFloat(); }
...
private:
	...
	void			ZapBeam( int nHand, Vector target );
	Vector			DetermineZapTarget();

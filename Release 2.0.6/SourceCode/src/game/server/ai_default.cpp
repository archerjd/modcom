...
void CAI_BaseNPC::InitDefaultScheduleSR(void)
{
	...
	ADD_DEF_SCHEDULE( "SCHED_FOLLOW_MASTER",			SCHED_FOLLOW_MASTER);
	ADD_DEF_SCHEDULE( "SCHED_FOLLOW_MASTER_VAGUE",		SCHED_FOLLOW_MASTER_VAGUE); // much less precise about the target pos
	ADD_DEF_SCHEDULE( "SCHED_HUNT_MASTER",				SCHED_HUNT_MASTER);
	ADD_DEF_SCHEDULE( "SCHED_IDLE_FAIL",				SCHED_IDLE_FAIL);
	ADD_DEF_SCHEDULE( "SCHED_WANDER_SMALL",		SCHED_WANDER_SMALL);
}
...
//	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_NONE);
	...
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_FOLLOW_MASTER );
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_FOLLOW_MASTER_VAGUE );
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_HUNT_MASTER );
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_IDLE_FAIL );
	AI_LOAD_DEF_SCHEDULE( CAI_BaseNPC,					SCHED_WANDER_SMALL );
	return true;
}
...
(
	...
	"	Tasks"
	"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_IDLE_FAIL"
	"		TASK_SET_TOLERANCE_DISTANCE		16"
	"		TASK_GET_PATH_TO_OBEY_MASTER	0"
	"		TASK_RUN_PATH					0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	""
	"	Interrupts"
...
(
	...
	"	Tasks"
	"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_IDLE_FAIL"
	"		TASK_SET_TOLERANCE_DISTANCE		140"
	"		TASK_GET_PATH_TO_OBEY_MASTER	0"
	"		TASK_RUN_PATH					0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	""
...
//=========================================================
// SCHED_HUNT_MASTER
//	pvm monsters hunt their target player, but now will divert if they see or hear someone else
//=========================================================
AI_DEFINE_SCHEDULE
(
	SCHED_HUNT_MASTER,
	...
	"	Tasks"
	"		TASK_SET_FAIL_SCHEDULE			SCHEDULE:SCHED_IDLE_FAIL"
	"		TASK_SET_TOLERANCE_DISTANCE		380"
	"		TASK_GET_PATH_TO_MASTER			0"
	"		TASK_RUN_PATH					0"
	"		TASK_WAIT_FOR_MOVEMENT			0"
	""
	"	Interrupts"

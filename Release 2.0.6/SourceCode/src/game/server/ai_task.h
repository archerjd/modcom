...
enum sharedtasks_e
{
		...
		// Path to our master player's origin
		TASK_GET_PATH_TO_MASTER,

		// path to position in formation around our master, or to where they want us to be
		TASK_GET_PATH_TO_OBEY_MASTER,

...
enum 
{
	...
	SCHED_FOLLOW_MASTER, // I'm coming, boss!
	SCHED_FOLLOW_MASTER_VAGUE, // I'm coming, boss - just not to precisely where you want me
	SCHED_HUNT_MASTER, // must... destroy...
	SCHED_IDLE_FAIL, // failed to follow master, don't stand around for a full SCHED_IDLE_STAND
	SCHED_WANDER_SMALL,

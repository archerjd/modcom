...
LINK_ENTITY_TO_CLASS(info_start_combine,CBaseDMStart);
LINK_ENTITY_TO_CLASS(info_start_resistance,CBaseDMStart);
LINK_ENTITY_TO_CLASS(info_start_aperture,CBaseDMStart);
LINK_ENTITY_TO_CLASS(info_player_start,CPointEntity);
LINK_ENTITY_TO_CLASS(info_landmark,CPointEntity);
LINK_ENTITY_TO_CLASS(info_npc_start,CPointEntity);

...
void CSatchelCharge::Spawn( void )
{
	...
	CHL2MP_Player *pOwner = ToHL2MPPlayer( GetOwnerEntity() );
	if ( pOwner )
	{
		m_flDamage *= pOwner->GetDamageDealtScale();
		//m_flDamage += m_flDamage * pOwner->GetFactionalDamageScaleBoost();
	}
...
#ifdef USE_OMNIBOT
int CSatchelCharge::GetOmnibotClass() const
{

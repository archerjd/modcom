...
protected:
	...
	CNetworkArray( string_t, m_szSuit, MAX_PLAYERS+1 );
...
//	CNetworkArray( int, m_iTotalExp, MAX_PLAYERS+1);
	CNetworkArray( int, m_iGameExp, MAX_PLAYERS+1);

	CNetworkArray( bool, m_bInChar, MAX_PLAYERS+1 );
	CNetworkArray( int, m_iFaction, MAX_PLAYERS+1 );
	CNetworkArray( Vector, m_vecPos, MAX_PLAYERS+1 );

...
void CServerGameDLL::CreateNetworkStringTables( void )
{
	...
	g_pNPCNamesStringTable = networkstringtable->CreateStringTable( "NPCNames", MAX_NPC_TYPES );
	g_pSkinOverrideStringTable = networkstringtable->CreateStringTable( "SkinOverrides", MAX_NPC_TYPES );
	g_pMapListStringTable = networkstringtable->CreateStringTable( "MapList", 32 ); // 32 is enough maps to pick from?

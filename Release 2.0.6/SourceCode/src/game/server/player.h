...
public:
...
#ifdef USE_OMNIBOT
	virtual int				GetOmnibotClass() const;
#endif
	...
	virtual Vector			GetAutoaimVector( float flScale, bool forceAutoaim = false );
	virtual Vector			GetAutoaimVector( float flScale, float flMaxDist, bool forceAutoaim = false );
	virtual void			GetAutoaimVector( autoaim_params_t &params, bool friendly = false, bool forceAutoaim = false );
	...
	QAngle					AutoaimDeflection( Vector &vecSrc, autoaim_params_t &params, bool friendly=false, bool forceAutoaim=false );
